...
const NewColumn = () => {
  ...
  return (
    <>
      ...
      <form
        action=""
        className="bg-gray-50  w-5/6 md:w-1/2 p-9 rounded-lg flex flex-col gap-2 absolute top-10 left-0 right-0  
        mx-auto z-20 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] animated animatedFadeInUp fadeInUp"
        onSubmit={handleAddNewColum}
      >
        <h2 className="font-bold">Add new card</h2>
        <input
